...
/* Joystick */
#define HAL_KEY_UP     '1'  // Joystick up
#define HAL_KEY_RIGHT  '2'  // Joystick right
#define HAL_KEY_CENTER '3'  // Joystick center
#define HAL_KEY_LEFT   '4'  // Joystick left
#define HAL_KEY_DOWN   '5'  // Joystick down
